...
const LinkViewPage = () => {
  ...
  useEffect(() => {
    const fetchLinks = async () => {
      try {
        ...
        if (userError || !userData?.user) { setError("Not authenticated."); return; }
  ...
  const handleDeleteLink = async (id: string) => {
    ...
    try {
      ...
      toast.success("Link channel deleted.");
    } catch {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="bg-[#111] border border-red-500/30 rounded-2xl p-6 max-w-sm w-full shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            ...
            <p className="text-gray-400 text-sm text-center mb-6 leading-relaxed">
              This will permanently delete the link and all its messages. This cannot be undone.
            </p>
              ...
              <div className="relative bg-[#0a0a0a] border border-white/10 rounded-2xl overflow-hidden hover:border-white/20 transition-all">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 sm:p-5 gap-3">
                  ...
                  <a
                    ...
                    className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0 cursor-pointer group/link"
                  >
                  ...
                  <div className="flex items-center gap-2 w-full sm:w-auto justify-between sm:justify-end border-t sm:border-t-0 border-white/5 pt-3 sm:pt-0 mt-1 sm:mt-0">
                    ...
                    <div className="flex items-center gap-2 ml-auto sm:ml-0">
                      <button
                        ...
                        className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-bold transition-all active:scale-95 whitespace-nowrap ${
                          copyStatus === item.id
